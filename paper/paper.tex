...
%======================================================================
\newpage   % start references in the next column so the final page fills both columns
\small
\begin{thebibliography}{9}
\setlength{\itemsep}{2pt}
\bibitem{voiceagentrag2026} Qiu, J., Zhang, J., Chen, Z., Yang, L., Zhu, M., Tan, J., et al. \emph{VoiceAgentRAG: Solving the RAG Latency Bottleneck in Real-Time Voice Agents Using Dual-Agent Architectures}, 2026. arXiv:2603.02206.
\bibitem{lts2026} Zou, Miao, Ma, Xu, Gao, Hao, He, and Xu. \emph{LTS-VoiceAgent: A Listen-Think-Speak Framework for Efficient Streaming Voice Interaction via Semantic Triggering and Incremental Reasoning}, 2026. arXiv:2601.19952.
...
\bibitem{chatsop2024} Li, Z., Peng, J., Wang, Y., Cao, Y., Shen, T., Zhang, M., et al. \emph{ChatSOP: An SOP-Guided MCTS Planning Framework for Controllable LLM Dialogue Agents}, 2024. arXiv:2407.03884.
\bibitem{paste2026} Sui, Y., Zhao, H., Ma, R., He, Z., Wang, H., Li, J., and Yang, Y. \emph{Act While Thinking: Accelerating LLM Agents via Pattern-Aware Speculative Tool Execution}, 2026. arXiv:2603.18897.
\bibitem{specrag2024} Wang, Z., Wang, Z., Le, L., Zheng, H.~S., Mishra, S., Perot, V., et al. \emph{Speculative RAG: Enhancing Retrieval Augmented Generation through Drafting}. ICLR 2025. arXiv:2407.08223.
...
\bibitem{shi2023} Shi, F., Chen, X., Misra, K., Scales, N., Dohan, D., Chi, E., et al. \emph{Large Language Models Can Be Easily Distracted by Irrelevant Context}. ICML 2023. arXiv:2302.00093.
